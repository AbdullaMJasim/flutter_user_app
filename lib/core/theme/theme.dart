...
class MaterialTheme {
  ...
  ThemeData theme(ColorScheme colorScheme) => ThemeData(
        ...
        textTheme: textTheme
            ...
            .copyWith(
              displayLarge: textTheme.displayLarge?.copyWith(color: colorScheme.primary),
              displayMedium: textTheme.displayMedium?.copyWith(color: colorScheme.primary),
              displaySmall: textTheme.displaySmall?.copyWith(color: colorScheme.primary),
              headlineLarge: textTheme.headlineLarge?.copyWith(color: colorScheme.primary),
              headlineMedium: textTheme.headlineMedium?.copyWith(color: colorScheme.primary),
              headlineSmall: textTheme.headlineSmall?.copyWith(color: colorScheme.primary),
              titleLarge: textTheme.titleLarge?.copyWith(color: colorScheme.primary),
              titleMedium: textTheme.titleMedium?.copyWith(color: colorScheme.primary),
              titleSmall: textTheme.titleSmall?.copyWith(color: colorScheme.primary),
            ),
        ...
        chipTheme: ChipThemeData(
          ...
          labelStyle: textTheme.bodySmall?.copyWith(color: colorScheme.primaryFixed),
